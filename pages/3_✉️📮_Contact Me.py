...
st.write("My name is Bryan, a former New York City 10th grade English teacher at a public high school in the South Bronx, devoted Pomehuahua stan, and self-taught data analyst who's fascinated by AI. Turns out that given AI's natural language processing basis, being an English teacher who knows R is a pretty helpful background for working with ChatGPT.")
